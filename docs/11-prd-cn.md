...
| 文档版本 | v1.1 |
| 文档日期 | 2026-06-11 |
| 当前阶段 | Testnet 合约闭环、MockUSDC 与 Sponsored Gas smoke 已验证；Mock Paylink 已有文件持久化和公开 `/pay/:id` 买家页；真实稳定币、Sponsor 请求持久化和事件索引尚未完成 |
| 产品负责人 | Founder |
...
3. 建立事件索引与链上回执。
4. 持久化 Sponsor request、Gas 预算和实际 Gas 成本。
